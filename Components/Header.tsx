  ...
  return (
    <>
      ...
      <div className={styles.title_container}>
        {/* <Link href="/" className={styles.homeLink}><img width="75" height="75" src="/icons/titleicon.svg"></img></Link> */}
        <Link href="/" className={styles.homeLink}><img width="75" height="75" src="/icons/iconmonstr-github-2.svg"></img></Link>
